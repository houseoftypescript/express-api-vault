...
const models: TsoaRoute.Models = {
  Secret: {
    dataType: 'refAlias',
    type: { dataType: 'nestedObjectLiteral', nestedProperties: { value: { dataType: 'any' } }, validators: {} },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(SecretsController.prototype.getSecret),

    function SecretsController_getSecret(request: any, response: any, next: any) {
      const args = {
  ...
  app.post(
    '/secrets/:key',
    ...fetchMiddlewares<RequestHandler>(SecretsController),
    ...fetchMiddlewares<RequestHandler>(SecretsController.prototype.setSecret),

    function SecretsController_setSecret(request: any, response: any, next: any) {
      const args = {
        key: { in: 'path', name: 'key', required: true, dataType: 'string' },
        undefined: { in: 'body', required: true, ref: 'Secret' },
      };
